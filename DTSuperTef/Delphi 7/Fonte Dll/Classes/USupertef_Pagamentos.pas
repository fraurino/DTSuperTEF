...
var
  ...
  Vpayment_uniqueid, Vpayment_status, Vpayment_message, Vid_payment,
    ...
    Vauthorization_date_time,Vacquirer_banco,Vacquirer_cnpj: string;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                JSONPaymentData.TryGetValue('acquirer_banco', Vacquirer_banco);
                JSONPaymentData.TryGetValue('acquirer_cnpj', Vacquirer_cnpj);
              end;
            end;
...
procedure Pagamento_acquirer_banco(Result: PAnsiChar); stdcall;
begin
  ResultLeRegistro := Vacquirer_banco;
  StrPCopy(Result, (ResultLeRegistro));
  Vacquirer_banco := '';
  ResultLeRegistro := '';
end;

procedure Pagamento_acquirer_cnpj(Result: PAnsiChar); stdcall;
begin
  ResultLeRegistro := Vacquirer_cnpj;
  StrPCopy(Result, (ResultLeRegistro));
  Vacquirer_cnpj := '';
  ResultLeRegistro := '';
end;
...
exports Pagamento_Cadastro, Pagamento_Detalha, Pagamento_Rejeita, ListaPOS,
  ...
  Pagamento_authorization_date_time,Pagamento_acquirer_banco,Pagamento_acquirer_cnpj;
